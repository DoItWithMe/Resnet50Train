...
from utils.image_utils_iscnet import (
    RandomEdgeEnhance,
...
from model.siamese_net import SiameseNetworkL2Net1, SiameseNetworkL2Net1WithSE, SiameseNetworkL2Net1WithOrthoNet
...
def main():
    ...
    # tmp_dataset = VtDataSet(
    #     dataset_dir=os.path.join("/data/jinzijian/resnet50/assets", "vt-imgs-train"),
    #     augmentations=None,
    #     preprocess=None,
    # )
    ...
    #     resetnet50_weight_path="/data/jinzijian/resnet50/assets/based-models/resnetv2_50x1_bit.goog_distilled_in1k.bin"
    # )
    
    model = SiameseNetworkL2Net1WithOrthoNet(
        resetnet50_weight_path="/data/jinzijian/resnet50/assets/based-models/gl18-tl-resnet50-gem-w-83fdc30.pth"
    )
    ...
    #     torch.load(
    #         "/data/jinzijian/resnet50/assets/best-models/test_18_2024-10-12-10_24_49.pth"
    #     )
    # )
    ...
    optimizer = optim.SGD(  # type:ignore
        model.parameters(), 0.01, momentum=0.9, weight_decay=1e-4
    )
    ...
    for epoch in range(num_epochs):
        ...
        if imgnet_dataloader_name in train_dataloader_dict.keys():
